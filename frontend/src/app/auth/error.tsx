        ...
        <main className="sm:flex">
          ...
          <div className="sm:ml-6">
            <div className="sm:border-l sm:border-gray-700 sm:pl-6">
              <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">Authentication Error</h1>
              <p className="mt-3 text-base text-gray-300">{error.message || 'An error occurred during authentication.'}</p>
            </div>
